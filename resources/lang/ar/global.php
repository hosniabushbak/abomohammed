...
return [
    ...
    'stopd_account_warning'          =>'حسابك متوقف عن إستقبال الطلبات',
    'saved'                          => 'تم الحفظ',
    ...
    'change_profile'                       =>'الإعدادات الشخصية',
    'delete_account'                       => 'حذف الحساب',
    'stop_account'                         =>'إيقاف حسابك من إستقبال الطلبات',
    'stop'                                 =>'إيقاف',
    'run'                                  =>'تشغيل',
    'delete_account_warning'               => 'ادخل الايميل الخاص بك لتأكيد أنك تريد حذف الحساب - هذا الإجراء لا يمكن التراجع عنه',
    'stop_account_warning'=>'ادخل الايميل الخاص بك لتأكيد أنك تريد إيقاف إستقبال الطلبات',
    'two_factor'                           => [
