    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sections.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('short_info_ar') ? 'is-invalid' : '' }}" name="short_info_ar" id="short_info_ar" required>{{ old('short_info_ar') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('short_info_en') ? 'is-invalid' : '' }}" name="short_info_en" id="short_info_en" required>{{ old('short_info_en') }}</textarea>
