...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-providerClients">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.client.fields.eventhead') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-providerClients:not(.ajaxTable)').DataTable({ buttons: dtButtons })
