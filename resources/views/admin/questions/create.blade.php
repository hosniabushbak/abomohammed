    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.questions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('question_ar') ? 'is-invalid' : '' }}" type="text" name="question_ar" id="question_ar" value="{{ old('question_ar', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('question_en') ? 'is-invalid' : '' }}" type="text" name="question_en" id="question_en" value="{{ old('question_en', '') }}" required>
