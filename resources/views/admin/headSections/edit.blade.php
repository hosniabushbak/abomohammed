...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.headSection.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.head-sections.update", [$headSection->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf

            <div class="form-group">
                <label class="required" for="title_ar">{{ trans('cruds.headSection.fields.title_ar') }}</label>
                <input class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}" type="text" name="title_ar" id="title_ar" value="{{ old('title_ar', $headSection->title_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('welcome_text_ar') ? 'is-invalid' : '' }}" type="text" name="welcome_text_ar" id="welcome_text_ar" value="{{ old('welcome_text_ar', $headSection->welcome_text_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('welcome_text_en') ? 'is-invalid' : '' }}" type="text" name="welcome_text_en" id="welcome_text_en" value="{{ old('welcome_text_en', $headSection->welcome_text_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('head_text_ar') ? 'is-invalid' : '' }}" type="text" name="head_text_ar" id="head_text_ar" value="{{ old('head_text_ar', $headSection->head_text_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('head_text_en') ? 'is-invalid' : '' }}" type="text" name="head_text_en" id="head_text_en" value="{{ old('head_text_en', $headSection->head_text_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sup_head_ar') ? 'is-invalid' : '' }}" type="text" name="sup_head_ar" id="sup_head_ar" value="{{ old('sup_head_ar', $headSection->sup_head_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sup_head_en') ? 'is-invalid' : '' }}" type="text" name="sup_head_en" id="sup_head_en" value="{{ old('sup_head_en', $headSection->sup_head_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sent_text_ar') ? 'is-invalid' : '' }}" type="text" name="sent_text_ar" id="sent_text_ar" value="{{ old('sent_text_ar', $headSection->sent_text_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sent_text_en') ? 'is-invalid' : '' }}" type="text" name="sent_text_en" id="sent_text_en" value="{{ old('sent_text_en', $headSection->sent_text_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text" name="start_date" id="start_date" value="{{ old('start_date', $headSection->start_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text" name="end_date" id="end_date" value="{{ old('end_date', $headSection->end_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('place_ar') ? 'is-invalid' : '' }}" type="text" name="place_ar" id="place_ar" value="{{ old('place_ar', $headSection->place_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('place_en') ? 'is-invalid' : '' }}" type="text" name="place_en" id="place_en" value="{{ old('place_en', $headSection->place_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_ar') ? 'is-invalid' : '' }}" type="text" name="name_ar" id="name_ar" value="{{ old('name_ar', $headSection->name_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_text_ar') ? 'is-invalid' : '' }}" type="text" name="name_text_ar" id="name_text_ar" value="{{ old('name_text_ar', $headSection->name_text_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_en') ? 'is-invalid' : '' }}" type="text" name="name_en" id="name_en" value="{{ old('name_en', $headSection->name_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_text_en') ? 'is-invalid' : '' }}" type="text" name="name_text_en" id="name_text_en" value="{{ old('name_text_en', $headSection->name_text_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_ar') ? 'is-invalid' : '' }}" type="text" name="email_ar" id="email_ar" value="{{ old('email_ar', $headSection->email_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_text_ar') ? 'is-invalid' : '' }}" type="text" name="email_text_ar" id="email_text_ar" value="{{ old('email_text_ar', $headSection->email_text_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_en') ? 'is-invalid' : '' }}" type="text" name="email_en" id="email_en" value="{{ old('email_en', $headSection->email_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_text_en') ? 'is-invalid' : '' }}" type="text" name="email_text_en" id="email_text_en" value="{{ old('email_text_en', $headSection->email_text_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_ar') ? 'is-invalid' : '' }}" type="text" name="mobile_ar" id="mobile_ar" value="{{ old('mobile_ar', $headSection->mobile_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_text_ar') ? 'is-invalid' : '' }}" type="text" name="mobile_text_ar" id="mobile_text_ar" value="{{ old('mobile_text_ar', $headSection->mobile_text_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_en') ? 'is-invalid' : '' }}" type="text" name="mobile_en" id="mobile_en" value="{{ old('mobile_en', $headSection->mobile_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_text_en') ? 'is-invalid' : '' }}" type="text" name="mobile_text_en" id="mobile_text_en" value="{{ old('mobile_text_en', $headSection->mobile_text_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('note_ar') ? 'is-invalid' : '' }}" type="text" name="note_ar" id="note_ar" value="{{ old('note_ar', $headSection->note_ar) }}" required>
            ...
            <div class="form-group">
                <label class="required" for="note_text_ar">{{ trans('cruds.headSection.fields.note_text_ar') }}</label>
                <input class="form-control {{ $errors->has('note_text_ar') ? 'is-invalid' : '' }}" type="text" name="note_text_ar" id="note_text_ar" value="{{ old('note_text_ar', $headSection->note_text_ar) }}" required>
                @if($errors->has('note_text_ar'))
                    <div class="invalid-feedback">
                        {{ $errors->first('note_text_ar') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.headSection.fields.note_text_ar_helper') }}</span>
            </div>

            <div class="form-group">
                <label class="required" for="note_en">{{ trans('cruds.headSection.fields.note_en') }}</label>
                <input class="form-control {{ $errors->has('note_en') ? 'is-invalid' : '' }}" type="text" name="note_en" id="note_en" value="{{ old('note_en', $headSection->note_en) }}" required>
            ...
            <div class="form-group">
                <label class="required" for="note_text_en">{{ trans('cruds.headSection.fields.note_text_en') }}</label>
                <input class="form-control {{ $errors->has('note_text_en') ? 'is-invalid' : '' }}" type="text" name="note_text_en" id="note_text_en" value="{{ old('note_text_en', $headSection->note_text_en) }}" required>
                @if($errors->has('note_text_en'))
                    <div class="invalid-feedback">
                        {{ $errors->first('note_text_en') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.headSection.fields.note_text_en_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="button_ar">{{ trans('cruds.headSection.fields.button_ar') }}</label>
                <input class="form-control {{ $errors->has('button_ar') ? 'is-invalid' : '' }}" type="text" name="button_ar" id="button_ar" value="{{ old('button_ar', $headSection->button_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('button_en') ? 'is-invalid' : '' }}" type="text" name="button_en" id="button_en" value="{{ old('button_en', $headSection->button_en) }}" required>
...
{{--            </div>--}}
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_from_day') ? 'is-invalid' : '' }}" type="text" name="event_from_day" id="event_from_day" value="{{ old('event_from_day', $headSection->event_from_day) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_to_day') ? 'is-invalid' : '' }}" type="text" name="event_to_day" id="event_to_day" value="{{ old('event_to_day', $headSection->event_to_day) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('zoom_details') ? 'is-invalid' : '' }}" name="zoom_details" id="zoom_details" required>
                    {{ old('zoom_details', $headSection->zoom_details) }}
                </textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zoom_url') ? 'is-invalid' : '' }}" type="text" name="zoom_url" id="zoom_url" value="{{ old('zoom_url', $headSection->zoom_url) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zoom_schedual_url') ? 'is-invalid' : '' }}" type="text" name="zoom_schedual_url" id="zoom_schedual_url" value="{{ old('zoom_schedual_url', $headSection->zoom_schedual_url) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meeting_id') ? 'is-invalid' : '' }}" type="text" name="meeting_id" id="meeting_id" value="{{ old('meeting_id', $headSection->meeting_id) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('passcode') ? 'is-invalid' : '' }}" type="text" name="passcode" id="passcode" value="{{ old('passcode', $headSection->passcode) }}" required>
