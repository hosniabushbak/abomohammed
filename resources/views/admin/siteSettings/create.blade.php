    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.site-settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('site_footer') ? 'is-invalid' : '' }}" name="site_footer" id="site_footer" required>{{ old('site_footer') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('key_words_ar') ? 'is-invalid' : '' }}" name="key_words_ar" id="key_words_ar">{{ old('key_words_ar') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('key_words_en') ? 'is-invalid' : '' }}" name="key_words_en" id="key_words_en">{{ old('key_words_en') }}</textarea>
